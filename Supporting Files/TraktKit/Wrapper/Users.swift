...
extension TraktManager {
    ...
    /**
     ...
     - parameter id: ID of the follower request. Example: `123`.
     */
    public func denyFollowRequest(requestID id: NSNumber, completion: SuccessCompletionHandler? = nil) -> URLSessionDataTask? {
        guard let request = mutableRequest(forPath: "users/requests/\(id)",
                                           withQuery: [:],
                                           isAuthorized: true,
    ...
    /**
     ...
     🔒 OAuth Required
     */
    public func hide(movies: [RawJSON]? = nil, shows: [RawJSON]? = nil, seasons: [RawJSON]? = nil, from section: SectionType, completion: ObjectCompletionHandler<HideItemResult>? = nil) throws -> URLSessionDataTask? {
        var json: [String : Any] = [:]
        json["movies"] = movies
        json["shows"] = shows
    ...
    /**
     ...
     🔒 OAuth Required
     */
    public func unhide(movies: [RawJSON]? = nil, shows: [RawJSON]? = nil, seasons: [RawJSON]? = nil, from section: SectionType, completion: ObjectCompletionHandler<UnhideItemResult>? = nil) throws -> URLSessionDataTask? {
        var json: [String : Any] = [:]
        json["movies"] = movies
        json["shows"] = shows
        json["seasons"] = seasons
    ...
    */
    ...
    /**
     ...
     🔒 OAuth Required
     */
    public func DeleteCustomList(username: String = "me", listID: String, completion: SuccessCompletionHandler? = nil) -> URLSessionDataTask? {
        guard
            let request = mutableRequest(forPath: "users/\(username)/lists/\(listID)",
                                         withQuery: [:],
                                         isAuthorized: true,
    ...
    🔒 OAuth Required
    */
    public func likeList<T: CustomStringConvertible>(username: String = "me", listID: T, completion: SuccessCompletionHandler? = nil) -> URLSessionDataTask? {
        guard
    ...
    /**
     ...
     🔒 OAuth Required
     */
    public func removeListLike<T: CustomStringConvertible>(username: String = "me", listID: T, completion: SuccessCompletionHandler? = nil) -> URLSessionDataTask? {
        guard
            let request = mutableRequest(forPath: "users/\(username)/lists/\(listID)/like",
                                         withQuery: [:],
                                         isAuthorized: true,
    ...
    */
    ...
    /**
     ...
     🔒 OAuth Required
     */
    public func unfollowUser(username: String, completion: SuccessCompletionHandler? = nil) -> URLSessionDataTask? {
        guard let request = mutableRequest(forPath: "users/\(username)/follow",
                                         withQuery: [:],
                                         isAuthorized: true,
                                         withHTTPMethod: .DELETE) else { return nil }
