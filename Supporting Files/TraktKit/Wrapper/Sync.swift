...
extension TraktManager {
     ...
     */
    public func getPlaybackProgress(type: WatchedType, extended: [ExtendedType] = [.min], completion: @escaping ObjectsCompletionHandler<PlaybackProgress>) -> URLSessionDataTask? {
    ...
    /**
     ...
     🔒 OAuth: Required
     */
    public func removePlaybackItem<T: CustomStringConvertible>(id: T, completion: SuccessCompletionHandler? = nil) -> URLSessionDataTask? {
    ...
    /**
     ...
     🔒 OAuth: Required
     */
    public func getHistory(type: TraktKit.WatchedType? = nil, traktID: String? = nil, extended: [ExtendedType] = [.min], pagination: Pagination? = nil, completion: @escaping HistoryCompletionHandler) -> URLSessionDataTask? {
    ...
    /**
     ...
     - parameter completion: completion handler
     */
    public func addToHistory(movies: [RawJSON], shows: [RawJSON], episodes: [RawJSON], completion: SuccessCompletionHandler? = nil) throws -> URLSessionDataTask? {
    ...
    /**
     ...
     - parameter completion: completion handler
     */
    public func removeFromHistory(movies: [RawJSON], shows: [RawJSON], episodes: [RawJSON], historyIDs: [NSNumber]? = nil, completion: SuccessCompletionHandler? = nil) throws -> URLSessionDataTask? {
    ...
    /**
     ...
     🔒 OAuth: Required
     */
    public func addToWatchlist(movies: [RawJSON], shows: [RawJSON], episodes: [RawJSON], completion: SuccessCompletionHandler? = nil) throws -> URLSessionDataTask? {
