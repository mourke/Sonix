...
internal extension TraktManager {
    ...
    func getTrending<T>(_ type: WatchedType, page: Int, limit: Int, extended: [ExtendedType] = [.min], completion: @escaping PaginatedCompletionHandler<T>) -> URLSessionDataTask? {
