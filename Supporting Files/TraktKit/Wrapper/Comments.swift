...
extension TraktManager {
    ...
    /**
     ...
     🔒 OAuth: Required
     */
    public func postComment(movie: RawJSON?,
                            show: RawJSON?,
                            episode: RawJSON?,
                            comment: String,
                            isSpoiler spoiler: Bool,
                            isReview review: Bool,
                            completionHandler: SuccessCompletionHandler? = nil) throws -> URLSessionDataTask? {
    ...
    /**
     ...
     🔒 OAuth: Required
     */
    public func deleteComment<T: CustomStringConvertible>(commentID id: T, completion: SuccessCompletionHandler? = nil) -> URLSessionDataTask? {
        guard
    ...
    /**
     ...
     🔒 OAuth: Required
     */
    public func likeComment<T: CustomStringConvertible>(commentID id: T, completion: SuccessCompletionHandler? = nil) -> URLSessionDataTask? {
    ...
    /**
     ...
     🔒 OAuth: Required
     */
    public func removeLikeOnComment<T: CustomStringConvertible>(commentID id: T, completion: SuccessCompletionHandler? = nil) -> URLSessionDataTask? {
        guard let request = mutableRequest(forPath: "comments/\(id)/like",
                                           withQuery: [:],
                                           isAuthorized: false,
                                           withHTTPMethod: .DELETE) else { return nil }
