...
extension TraktManager {
     ...
     */
    public func scrobbleStart(movie: RawJSON, progress: Float, appVersion: String, appBuildDate: Date, completion: ObjectCompletionHandler<ScrobbleResult>? = nil) throws -> URLSessionDataTask? {
     ...
     **Note**: A watching status will auto expire after the remaining runtime has elpased. There is no need to re-send every 15 minutes.
     ...
     - parameter appBuildDate: Build date of the app.
     */
    public func scrobbleStart(episode: RawJSON, progress: Float, appVersion: String, appBuildDate: Date, completion: ObjectCompletionHandler<ScrobbleResult>? = nil) throws -> URLSessionDataTask? {
        return try scrobble("start",
                            movie: nil,
                            episode: episode,
                            progress: progress,
    ...
    /**
     ...
     🔒 OAuth: Required
     */
    public func scrobblePause(movie: RawJSON, progress: Float, appVersion: String, appBuildDate: Date, completion: ObjectCompletionHandler<ScrobbleResult>? = nil) throws -> URLSessionDataTask? {
    ...
    /**
     ...
     🔒 OAuth: Required
     */
    public func scrobblePause(episode: RawJSON, progress: Float, appVersion: String, appBuildDate: Date, completion: ObjectCompletionHandler<ScrobbleResult>? = nil) throws -> URLSessionDataTask? {
        return try scrobble("pause",
                            movie: nil,
                            episode: episode,
                            progress: progress,
     ...
     **Note**: If you prefer to use a threshold higher than 80%, you should use **GET** `/scrobble/pause` yourself so it doesn't create duplicate scrobbles.
     ...
     🔒 OAuth: Required
     */
    public func scrobbleStop(movie: RawJSON, progress: Float, appVersion: String, appBuildDate: Date, completion: ObjectCompletionHandler<ScrobbleResult>? = nil) throws -> URLSessionDataTask? {
     ...
     **Note**: If you prefer to use a threshold higher than 80%, you should use **GET** `/scrobble/pause` yourself so it doesn't create duplicate scrobbles.
     ...
     🔒 OAuth: Required
     */
    public func scrobbleStop(episode: RawJSON, progress: Float, appVersion: String, appBuildDate: Date, completion: ObjectCompletionHandler<ScrobbleResult>? = nil) throws -> URLSessionDataTask? {
        return try scrobble("stop",
                            movie: nil,
                            episode: episode,
                            progress: progress,
    ...
    @discardableResult
    private func scrobble(_ scrobbleAction: String, movie: RawJSON?, episode: RawJSON?, progress: Float, appVersion: String, appBuildDate: Date, completion: ObjectCompletionHandler<ScrobbleResult>?) throws -> URLSessionDataTask? {
        ...
        var json: RawJSON = [
            "progress": progress,
            "appVersion": appVersion,
            "appBuildDate": formatter.string(from: appBuildDate)
        ]
